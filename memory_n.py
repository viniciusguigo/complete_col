...
class MemoryN(object):
    def __init__(self, limit, action_shape, observation_shape, max_n):
        """
        ...
        :param max_n: (int) the max number of steps
        """
        self.limit = limit

        self.observations0 = RingBuffer(limit, shape=observation_shape)
        self.actions = RingBuffer(limit, shape=action_shape)
        self.rewards = RingBuffer(limit, shape=(max_n,))
        self.terminals1 = RingBuffer(limit, shape=(max_n,))
